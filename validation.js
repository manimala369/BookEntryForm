function validateBook() {
    ...
    if(!isValidIsbn(isbn)) {
        document.getElementById("isbnMsg").innerHTML = "Enter valid isbn number (min length should be 6)";
    ...
    if(!isValidCopies(copies)) {
        document.getElementById("copiesMsg").innerHTML = "Enter valid number";
